      ...
      <div className="flex-1 px-4 py-6">
        <div className="space-y-3 max-w-md mx-auto">
          ...
          <div className="pt-4 pb-2">
            <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">About Ads</h3>
          </div>
          ...
          >
            ...
            <ul className="text-sm text-blue-600 space-y-1">
              <li>• Banner ads appear after Level 20</li>
              <li>• Full-screen ads every 5 levels after Level 20</li>
              <li>• Watch ads for extra lives</li>
            </ul>
          ...
          <div className="pt-6 text-center">
            <p className="text-sm text-gray-400">Arrow Puzzle v1.9.3 (test ads)</p>

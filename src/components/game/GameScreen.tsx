...
export default function GameScreen() {
  ...
  useEffect(() => {
    if (levelComplete) {
      // Use requestAnimationFrame to defer setState out of the synchronous
      // effect body and avoid cascading renders (React 19 lint rule).
  ...
  return (
    ...
    >
      ...
      {/* Bottom section — banner ad renders here on native after level 20 */}
      <div className="pb-4">
        <AdBanner />
      </div>
    </div>

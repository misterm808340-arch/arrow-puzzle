...
export default function GameOverScreen() {
  ...
  const handleWatchAd = () => {
    // The rewarded ad already played inside RewardedAdPlaceholder (which
    // calls showRewardedAd() and confirms the reward via onUserEarnedReward).
    // onReward is only called when result.rewarded === true, so we can grant
    // the life immediately — no artificial delay needed.

...
public class AdMobPlugin extends Plugin {
    ...
    // ===== Ad unit IDs =====
    //
    // TEST MODE — Google's official sample ad units.
    // These always return a fill and are safe to click.
    // To switch to PRODUCTION, comment the TEST block and uncomment PRODUCTION.
    //
    // --- PRODUCTION ---
    ...
    //
    // --- TEST ---
    private static final String AD_UNIT_BANNER = "ca-app-pub-3940256099942544/6300978111";

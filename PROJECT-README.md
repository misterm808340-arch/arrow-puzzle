# Arrow Puzzle — v1.9.3 (Google AdMob)
...
│   ├── arrow-puzzle-v1.9.3.apk           # Direct install
│   ├── arrow-puzzle-v1.9.3.aab           # Play Store upload
...
```bash
adb install download/arrow-puzzle-v1.9.3.apk
```
...
Upload `download/arrow-puzzle-v1.9.3.aab` to Play Console. The Data Safety

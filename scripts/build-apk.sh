#!/bin/bash
# Build production APK + AAB (Google AdMob since v1.9.3)
set -e
...
cp android/app/build/outputs/apk/release/app-release.apk \
   download/arrow-puzzle-v1.9.3.apk
cp android/app/build/outputs/bundle/release/app-release.aab \
   download/arrow-puzzle-v1.9.3.aab
ls -lh download/arrow-puzzle-v1.9.3.apk download/arrow-puzzle-v1.9.3.aab

echo ""
echo "=== Verifying APK ==="
aapt dump badging download/arrow-puzzle-v1.9.3.apk | grep -E "package:|versionCode|versionName|application-label:" | head -5

echo ""
echo "=== Signing verification ==="
apksigner verify --verbose download/arrow-puzzle-v1.9.3.apk 2>&1 | head -8

echo ""
echo "=== Sanity: AdMob + UMP classes present in APK? ==="
unzip -l download/arrow-puzzle-v1.9.3.apk | grep -E "com/google/android/gms/ads|com/google/android/ump" | head -5 || echo "(none found — check Gradle resolution)"

echo ""
echo "=== DONE ==="
echo "APK:  /home/z/my-project/download/arrow-puzzle-v1.9.3.apk"
echo "AAB:  /home/z/my-project/download/arrow-puzzle-v1.9.3.aab"
